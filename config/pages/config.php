...
<div  id="og_app_fb_group" class="form-group">
		<label class="col-sm-3 control-label">APP ID Facebook: </label>
	   <div class="col-sm-9">
		<input group="og" class="form-control" <?php  if ($og_tag!="1") echo ('disabled');  ?>  id="fb_app_id" type="text" name="fb_app_id" value="<?php echo $fb_app_id ?>" placeholder="APP ID Facebook">
		<span class="help-block">APP ID Facebook</span>
</div>
</div>
   ...
   <div class="panel-body">
	...
	<legend><small>Данные для ценообразования товара на одностраничнике</small></legend>
     ...
     <select group="price" id="valuta" name="valuta" required class="form-control" onchange="valuta_func(); return true;" >
		...
		<label class="col-sm-3 control-label">Цена за 1: <em>*</em></label>
...
<div id="price_new_group2" class="form-group">
		<label class="col-sm-3 control-label">Цена за комплект: <em>*</em></label>
	   <div class="col-sm-9"><div class="input-group">
		<input group="price" class="form-control" required id="price_new2" type="number" name="price_new2" value="<?php echo  $price_new2 ?>" placeholder="Новая цена. Размещается во всех местах ленда">
		<span class="input-group-addon vlt"><?php  if ($valuta!="") echo $valuta; else echo ('<i class="fa fa-spinner fa-pulse fa-fw"></i>') ?></span>
</div>
</div>
</div>
...
<div id="price_new_group4" class="form-group">
		<label class="col-sm-3 control-label">Цена за овощной нож: <em>*</em></label>
	   <div class="col-sm-9"><div class="input-group">
		<input group="price" class="form-control" required id="price_new4" type="number" name="price_new4" value="<?php echo  $price_new4 ?>" placeholder="Новая цена. Размещается во всех местах ленда">
		<span class="input-group-addon vlt"><?php  if ($valuta!="") echo $valuta; else echo ('<i class="fa fa-spinner fa-pulse fa-fw"></i>') ?></span>
</div>
</div>
</div>
...
<div id="price_new_group5" class="form-group">
		<label class="col-sm-3 control-label">Цена за термозонд: <em>*</em></label>
	   <div class="col-sm-9"><div class="input-group">
		<input group="price" class="form-control" required id="price_new5" type="number" name="price_new5" value="<?php echo  $price_new5 ?>" placeholder="Новая цена. Размещается во всех местах ленда">
		<span class="input-group-addon vlt"><?php  if ($valuta!="") echo $valuta; else echo ('<i class="fa fa-spinner fa-pulse fa-fw"></i>') ?></span>
</div>
</div>
</div>
...
<div id="price_new_group3" class="form-group">
		<label class="col-sm-3 control-label">Цена за точилку: <em>*</em></label>
	   <div class="col-sm-9"><div class="input-group">
		<input group="price" class="form-control" required id="price_new3" type="number" name="price_new3" value="<?php echo  $price_new3 ?>" placeholder="Новая цена. Размещается во всех местах ленда">
		<span class="input-group-addon vlt"><?php  if ($valuta!="") echo $valuta; else echo ('<i class="fa fa-spinner fa-pulse fa-fw"></i>') ?></span>
</div>
</div>
</div>
...
<div id="tele_mess_group" class="form-group <?php  if ($tele_id=="") echo "hidden"; ?>">
  ...
  <div class="panel-heading">
   <h4 class="panel-title"> <i class="fa fa-telegram"></i>&#160;
       <a data-toggle="collapse" data-parent="#accordion" href="#telegram2-block">
        Telegram-bot CallCentre:
       </a>&#160;<i class="fa fa-caret-down" aria-hidden="true"></i>
	   <span id="tlg2" class="panel-heading-info hidden"><small>Есть не заполненные поля!</small></span>
      </h4>
  </div>
  <div id="telegram2-block" class="panel-collapse collapse">
   <div class="panel-body">
	  <fieldset>
	  <fieldset>
	   	 <legend><small>Настройки отправки заказа на Telegram-bot CallCentre</small></legend>
	  <div class="form-group">
    <label class="col-sm-3 control-label">ID <a title="@svdirect_bot Telegram" href="https://t.me/svdirect_bot?start=<?php echo  base64_encode($_SERVER['SERVER_NAME']); ?>" target="_blank">@svdirect_bot</a>: </label><div class="col-sm-9"><input group="tlg" class="form-control" id="managerID" type="number" name="managerID" value="<?php echo  $managerID ?>" placeholder="Ваш ID в телеграм-боте @svdirect_bot">
	 <span class="help-block">Для получения кода подключитесь к телеграм-боту <a title="@svdirect_bot Telegram" href="https://t.me/svdirect_bot?start=<?php echo  base64_encode($_SERVER['SERVER_NAME']); ?>" target="_blank">@svdirect_bot</a> и дайте команду <b>/start</b>.<br>Следуйте полученным инструкциям</span></div>
</div>

<div class="form-group">
    <label class="col-sm-3 control-label">ID Чата КЦ: </label><div class="col-sm-9"><input group="tlg" class="form-control" id="ChatID" type="number" name="ChatID" value="<?php echo  $ChatID ?>" placeholder="ID Чата Колл-Центра обработки заявок">
	 <span class="help-block">Для получения кода обратитесь к Вашему программисту (-566584299)</span></div>
</div>


<div id="tele_mess_group" class="form-group">
    <label class="col-sm-3 control-label">НикНейм:</label><div class="col-sm-9"><input required group="tlg" class="form-control" id="managerName" type="text" name="managerName" value="<?php  if ($managerName!="") echo $managerName;  ?>" placeholder="Ваш НикНейм">
    	<span class="help-block">Для получения НикНейма обратитесь к Вашему программисту</span>
	 </div>
</div>
 ...
 -->
  ...
  <div id="thanks-block" class="panel-collapse collapse">
   <div class="panel-body">
    ...
    <label class="col-sm-3 control-label" for="thanks1">Поздравление: </label><div class="col-sm-9"><input group="thanks" class="form-control" id="thanks1" type="text" name="thanks1" required value="<?php if ($thanks1!="") echo $thanks1; else echo  $config['thanks']['text1']; ?>" placeholder="Поздравление с покупкой"></div></div>
		 <div id="thanks2_group" class="form-group">
	<label class="col-sm-3 control-label" for="thanks2">Оповещение: </label><div class="col-sm-9"><input required value="<?php if ($thanks2!="") echo $thanks2; else echo  $config['thanks']['text2']; ?>"group="thanks" class="form-control" id="thanks2" type="text" name="thanks2" placeholder="Оповещение о звонке оператора"></div></div>
	 <div id="thanks3_group" class="form-group">
	 <label class="col-sm-3 control-label" for="thanks3">Ссылка на повтор: </label><div class="col-sm-9"><input group="thanks" class="form-control" id="thanks3" type="text" name="thanks3" required value="<?php if ($thanks3!="") echo $thanks3; else echo  $config['thanks']['text3']; ?>" placeholder="Ссылка на повтор ввода, в случае ошибки">
